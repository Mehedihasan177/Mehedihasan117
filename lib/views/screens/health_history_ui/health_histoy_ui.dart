              ...
              children: [
                Expanded(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) => CarePlusPrescriptionsList()));
          ...
          Container(
            ...
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final item = health_history[index];
                  return GestureDetector(
                      ...
                      child: Health_History_List(item));
                }),
